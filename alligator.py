...
class Alligator():
    ...
    def __init__(self):
        ...
        self.much_window.set_icon_from_file('alligator.png')
        self.much_window.connect('destroy', lambda w: gtk.main_quit())
        self.much_window.set_default_size(1200, 600)
        self.much_window.maximize()
    ...
    def change_title(self, widget, frame, title):
        self.much_window.set_title('Welcome To ' + title)
